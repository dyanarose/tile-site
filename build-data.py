...
out = f"// Auto-generated from batches.yaml + tiles.yaml + glazes.yaml\n// Edit the YAML files, then run: python build-data.py\nwindow.SITE_DATA = {json.dumps({'batches': batches, 'tiles': tiles, 'glazes': glazes}, indent=2, ensure_ascii=False)};\n"
